...
@section('contenido')
{{--
<!-- @isset($mensaje) {  {  $mensaje  }  } @endisset -->
<!-- {  {  $mensaje2  }  } -->
<!-- {  {  $mensaje ?? '' } } -->
<!-- {  !   $mensaje ?? '' !    } -->
--}}
    ...
    border-top-right-radius: 0px;
		...
		<div class="container-login100">
			<div class="wrap-login100 p-b-160 p-t-50">
				<form action="{{ url('userhome') }}" method="get"class="login100-form validate-form">
				  @csrf
				    @isset ($mensaje)
                     <h2> {{ $mensaje }} </h2>
                    @endisset
					...
					<div class="wrap-input100 rs1 validate-input" data-validate = "Username is required">
							<input class="input100" type="text" name="nombre" id="nombrefp" required value="{{ old('nombre') }}">
						<span class="label-input100">Username</span>
					</div>
					
					
					<div class="wrap-input100 rs2 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="clave" id="clave" required value="{{ old('clave') }}">
				...
				<form action="{{url('forgoten')}}" method="get" class="login100-form validate-form">
				  <div class="container-login100-form-btn">
						<button class="login100-form-btn">
							Forgoten
						</button>
